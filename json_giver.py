...
def main():
    ...
    # Process all 154 pages
    for page_num in range(1, 155):  # 1 to 154 inclusive
        page_url = (
            f"https://jmedicalcasereports.biomedcentral.com/articles"
            f"?searchType=journalSearch&sort=PubDate&page={page_num}"
        )
